...
<div key={index} className="flex flex-col m-6">
  ...
  return (
    <>
      ...
      <div>
        <h2 className="text-4xl font-extrabold text-center m-14" >Exam Construction Suite</h2>
        ...
        {generateInputs()}
        <button className=" mb-6 ml-8 mt-0 bg-blue-950 hover:bg-blue-700 text-white py-2 px-2 rounded-lg shadow-md hover:shadow-lg transition duration-300 ease-in-out" onClick={handleSubmit}>Submit</button>
        {evaluationMessage && <p className="text-4xl font-extrabold text-center mb-24 " >{evaluationMessage}</p>}
